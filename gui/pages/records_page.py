...
class RecordsPage:
    ...
    def setup_header(self):
        ...
        self.view_btn.pack(side='right', padx=(10, 0))
    ...
    def setup_content(self):
        ...
        search_label = ttk.Label(search_frame, text="🔍 Search Records:")
        ...
        self.records_tree.column('Total Cost', width=100, anchor='center')
        self.records_tree.column('Total Paid', width=100, anchor='center')
        self.records_tree.column('Balance', width=100, anchor='center')
        self.records_tree.column('Created', width=150, anchor='center')
